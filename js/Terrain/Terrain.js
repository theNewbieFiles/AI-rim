...
function TerrainManager(Scene){
        ...
        for (let k in newTerrainChunks) {
            ...
            if(k in chunks){
                ...
                chunks[k] = {
                    ...
                    chunk: createTerrainChunk(k, newTerrainChunks[k].center, newTerrainChunks[k].dimensions),
    ...
    function createTerrainChunk(Name, Center, Dimensions, Offset) {
 ...
 * @constructor
 */
function TerrainChunk(Manager, Name, Center, Dimensions, Group, ) {
